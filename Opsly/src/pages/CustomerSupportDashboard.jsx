    ...
    <DashboardLayout userName="Martin">
      <div className="min-w-0 max-w-full">
        ...
        <div className="bg-opsly-card rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6">Customer Insights</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="bg-opsly-dark rounded-lg p-4 sm:p-6">
              ...
              <p className="text-3xl sm:text-4xl font-bold text-white">32</p>
            </div>
            <div className="bg-opsly-dark rounded-lg p-4 sm:p-6 sm:col-span-2 md:col-span-1">
              ...
              <p className="text-3xl sm:text-4xl font-bold text-white">3.2 min</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-opsly-card rounded-lg p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-400 mt-1">8 new tickets</p>
            </div>
          </div>
